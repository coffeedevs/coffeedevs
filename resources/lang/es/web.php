...
return [
 ...
 de contratar desarrolladores profesionales. Tenemos la pericia técnica para arquitecturar y desplegar tu aplicación como la imaginas.</p>
                ...
                <p>Como emprendedores y pensadores creativos nosotros mismos,  podemos ayudarte con mucho más que desarrollo web.
                Nos encanta ayudar a nuestros clientes a idear características que mejoren la experiencia de usuario.
...
Si necesitas más información en cualquiera de los items que ves aquí, no dudes en preguntar.</p>
                <ul>
                    ...
                    <li>Depuración de aplicaciones y corrección de errores</li>
                    <li>Mantenimiento y refactorización de código</li>
                    <li>Análisis y parches de seguridad para tu sitio web</li>
                    <li>Análisis de rendimiento y pruebas de estrés web</li>
                    <li>Planificación e implementación de escalado para sitios de alto tráfico</li>
...
Alentamos el uso de herramientas modernas que automatizan el trabajo con recursos de frontend como Gulp o Webpack.</p>
                ...
                <h2>INTEGRACIONES PERSONALIZADAS CON API\'S DE TERCEROS</h2>
                <p>La mayoría de las startups están construidas encima de por lo menos un API. Asegurate que esté hecho bien a la primera.</p>

                <p>Hemos integrado cantidad incontable de APIs de terceros y podremos con la tuya! Como nos especializamos en construir startups,
                tenemos experiencia trabajando con APIs de proveedores de servicios, su documentación y en la habilitación de características como 
                login con redes sociales, facturación automática, geolocalización y mucho más.</p>
        ...
        '4' => [
            ...
            'text' => '<p>Tenemos décadas de experiencia diagnosticando y corrigiendo problemas de rendimiento en sitios web.
                ...
                <p>Somos confiados en que podemos entregarte resultados, mejorando la puntuación en sitios comúnes como GTMetrix o Google\'s PageSpeed Insights,
                reduciendo los tiempos de carga de páginas críticas, y proporcionándote con un plan estratégico de escalado para el futuro.
                Estas son solo algunas de las cosas que vamos a estar mirando:</p>

                <ul>
                    <li>Imágenes muy grandes o mal optimizadas.</li>
                    <li>Servidor web mal configurado o lenguaje de programación utilizando una versión anticuada.</li>
                    <li>Servidor Linux sobreutilizado o muy chico.</li>
                    <li>Código pobremente escrito, resultando en algoritmos de alta complejidad y bajo rendimiento.</li>
                    <li>Consultas a la base de datos poco optimizadas, o columnas consultadas sin indizar.</li>
        ...
        '5' => [
            ...
            optimizaciones en las páginas de tu sitio, así como creamos landing pages y publicaciones de blog altamente enfocadas para capitalizar en el incremento
